...
//活动关卡，总在最前
var extraRaw = {
'联盟委托: 5-1': [0.9, 0.9, -1.1, 1.2, -0.67],
'联盟委托: 5-2': [1.1, 0.67, -0.67, 1.2, -0.67],
'联盟委托: 5-3': [0.67, -0.9, -0.67, -0.9, 0.4],
'联盟委托: 5-4': [-1, -1, 1, -1, 1],
'联盟委托: 5-5': [1, 1, -1, 1, 1],
'联盟委托: 5-6': [1, -1, 1, 1, 1],
'联盟委托: 5-7': [-1, 1, -1, 1, 1],
...
"萤火虫之舞": [addBonusInfo('A', 1, "舞者")],
  ...
  '联盟委托: 5-4': [addBonusInfo('S', 1, "摇滚风")],
  '联盟委托: 5-5': [addBonusInfo('A', 1, "森女系列")],
  '联盟委托: 5-6': [addBonusInfo('A', 1, "防晒")],
  '联盟委托: 5-7': [addBonusInfo('A', 1, "童话系")],
 };
...
'联盟委托: 5-1' :[['连衣裙/上下装怀疑要求民国服饰tag。'],['画家·白，春山新雨，小镇姑娘，民国少女'],['']],
'联盟委托: 5-2' :[['欢迎反馈F品！'],['盲目的爱，音符跃动，各种小满，名媛连衣裙·棕，温雅侍者·衣，学生主席，民国少女，格调短裙们。等F表比较全了就不写这么细了啊'],['学士服，巧克力物语·棕，高音谱号']],
'联盟委托: 5-3' :[[''],['温雅侍者·马甲，职场佳丽，双色甜筒，OL的衬衫·白，神圣医者·裙'],['维纳斯之舞，轻羽裙·灰']],
'联盟委托: 5-4' :[['属性和tag都只列出了种类，权重晚些更新。欢迎反馈F品！怕F请多看留言板~'],['硬式咆哮，铆钉抹胸，摇滚歌手。不确定的有特别行动、月之咒语·上'],['超级特工·裤、性感不良·下装、月之咒语·下（全部待确认）']],
'联盟委托: 5-5' :[['属性和tag都只列出了种类，权重晚些更新。欢迎反馈F品！怕F请多看留言板~'],['森女与麋鹿，丘丘，小然，暖茸'],['草莓裙和外套容易F，请当心']],
'联盟委托: 5-6' :[['属性和tag都只列出了种类，权重晚些更新。欢迎反馈F品！怕F请多看留言板~'],['迷雾街头，沁蜜桃，薏米仁'],['']],
'联盟委托: 5-7' :[['属性和tag都只列出了种类，权重晚些更新。欢迎反馈F品！怕F请多看留言板~'],['荧珑·华丽，桃心骑士，红马甲'],['']],
};
