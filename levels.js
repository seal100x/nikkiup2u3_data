...
//'繁星7-诸星归位': [addBonusInfo('A', 1, "中式现代"), addBonusInfo('A', 1, '中式古典')],
  "海樱的委托": [addBonusInfo('C', 1, "冬装")],
  "恶魔的诊所": [addBonusInfo('S', 1, "哥特风")],
  "桃桃的考验（一）": [addBonusInfo('B', 1, "医务使者")],
  "桃桃的考验（三）": [addBonusInfo('C', 1, "未来系")],
  "1-1": [],
  "1-2": [],
...
var addHintInfo = {
'海樱的委托' :[['建议用现成攻略，注意攻略对技能释放的要求（如果有）。'],[''],['']],
'恶魔的诊所' :[['建议用现成攻略，注意攻略对技能释放的要求（如果有）。'],[''],['']],
'桃桃的考验（一）' :[['建议用现成攻略，注意攻略对技能释放的要求（如果有）。'],[''],['']],
'桃桃的考验（二）' :[['建议用现成攻略，注意攻略对技能释放的要求（如果有）。'],[''],['']],
'桃桃的考验（三）' :[['建议用现成攻略，注意攻略对技能释放的要求（如果有）。'],[''],['']],
'1-1' :[[''],[''],['游园·紫']],
