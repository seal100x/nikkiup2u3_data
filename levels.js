...
"萤火虫之舞": [addBonusInfo('A', 1, "舞者")],
  ...
  '联盟委托: 5-2': [addBonusInfo('A', 1, "学院系"), addBonusInfo('A', 1, "英伦")],
  //'联盟委托: 5-3': [addBonusInfo('A', 1, "小动物")],
  //'联盟委托: 5-4': [addBonusInfo('A', 1, "小动物")],
  //'联盟委托: 5-5': [addBonusInfo('A', 1, "小动物")],
  //'联盟委托: 5-6': [addBonusInfo('A', 1, "小动物")],
  //'联盟委托: 5-7': [addBonusInfo('A', 1, "小动物")],
 };
...
'联盟委托: 4-7' :[['上下装容易F。'],['巧克力女仆'],['']],
 '联盟委托: 5-1' :[['属性和tag都只列出了种类，权重晚些更新。欢迎大家反馈F品！怕F请多看留言板~'],['画家·白，春山新雨，小镇姑娘，民国少女'],['']],
 '联盟委托: 5-2' :[['属性和tag都只列出了种类，权重晚些更新。欢迎大家反馈F品！怕F请多看留言板~'],['小满校服·红，小满制服·格纹，名媛连衣裙·棕，盲目的爱'],['']],
//'联盟委托: 5-3' :[['属性和tag都只列出了种类，权重晚些更新。欢迎大家反馈F品！'],[''],['']],
//'联盟委托: 5-4' :[['属性和tag都只列出了种类，权重晚些更新。欢迎大家反馈F品！'],[''],['']],
//'联盟委托: 5-5' :[['属性和tag都只列出了种类，权重晚些更新。欢迎大家反馈F品！'],[''],['']],
//'联盟委托: 5-6' :[['属性和tag都只列出了种类，权重晚些更新。欢迎大家反馈F品！'],[''],['']],
//'联盟委托: 5-7' :[['属性和tag都只列出了种类，权重晚些更新。欢迎大家反馈F品！'],[''],['']],
};
