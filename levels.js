 ...
 */
 var levelBonus = {
  ...
  '13-1': [addBonusInfo('SS', 1, "波西米亚")],
  '13-3': [addBonusInfo('A', 1, "摇滚风")],
  '13-4': [addBonusInfo('A', 1, "围裙")],
  '13-5': [addBonusInfo('A', 1, "波西米亚"), addBonusInfo('A', 1, "民族风")],
  '13-6': [addBonusInfo('A', 1, "中式古典")],
  '13-7': [addBonusInfo('A', 1, "童话系"), addBonusInfo('A', 1, "洛丽塔")],
  '13-8': [addBonusInfo('A', 1, "欧式古典")],
  '13-支2': [addBonusInfo('A', 1, "未来系")],
...
'12-支3' :[[''],[''],['']],
'13-1': [['tag不准，待更新'],[''],['']],
'13-3': [['要求月之诅咒·上+下，慎穿外套，发现其它可用衣服请反馈！tag不准，待更新。'],[''],['']],
'13-4': [['tag不准，待更新'],[''],['']],
'13-5': [['要求苍穹之鹰，慎穿外套，发现其它可用衣服请反馈！tag不准，待更新'],[''],['']],
'13-6': [['tag不准，待更新'],[''],['']],
'13-7': [['tag不准，待更新'],[''],['']],
'13-8': [['tag不准，待更新'],[''],['']],
'13-9': [['要求森林之歌，慎穿外套，发现其它可用衣服请反馈！'],[''],['']],
'13-支2': [['tag不准，待更新'],[''],['']],
'13-支3': [['tag不准，待更新'],[''],['']],
'联盟委托: 3-1' :[[''],[''],['']],
'联盟委托: 3-2' :[[''],[''],['']],
